...
TransactionManager::TransactionManager(const QString &connectionName, QObject *parent)
    : QObject(parent), connectionName(connectionName), logger("TransactionManager")
{
